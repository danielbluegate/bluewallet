...
function feedtokenbalance() {

  contract.methods.balanceOf('0xe44a3816766CBe21A441991a026C91678026cE8c').call().then(function (bal) {
    var finalfeedbal = bal / 1000000000000000000;
    var feedbaltostring = finalfeedbal.toString();
    document.getElementById('tokenbal').innerHTML += feedbaltostring + " MDNT <br>";
  })
}
